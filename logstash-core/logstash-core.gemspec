...
Gem::Specification.new do |gem|
  ...
  # TEMPORARY: Rufus Scheduler 3.8.x subtly breaks thread joining, which
  # is done in several plugins to handle shutdowns. Pin pending migration
  # to shared Scheduler Mixin.
