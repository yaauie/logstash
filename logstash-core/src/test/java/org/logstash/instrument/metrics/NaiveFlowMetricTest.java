...
import static org.logstash.instrument.metrics.NaiveFlowMetric.CURRENT_KEY;
import static org.logstash.instrument.metrics.NaiveFlowMetric.LIFETIME_KEY;

public class NaiveFlowMetricTest {
    @Test
    public void testBaselineFunctionality() {
        ...
        final NaiveFlowMetric instance = new NaiveFlowMetric(clock::nanoTime, "flow", numeratorMetric, denominatorMetric);
